...
// The `response` message contains the version of Diginfra.
...
var file_version_proto_goTypes = []interface{}{
	(*Request)(nil),  // 0: diginfra.version.request
	(*Response)(nil), // 1: diginfra.version.response
}
var file_version_proto_depIdxs = []int32{
	0, // 0: diginfra.version.service.version:input_type -> diginfra.version.request
	1, // 1: diginfra.version.service.version:output_type -> diginfra.version.response
