//
//Copyright (C) 2020 The Diginfra Authors.
//
...
import (
	schema "github.com/diginfra/client-go/pkg/api/schema"
...
// It contains all the elements that Diginfra emits in an output along with the
...
type Response struct {
	...
	Priority schema.Priority      `protobuf:"varint,2,opt,name=priority,proto3,enum=diginfra.schema.Priority" json:"priority,omitempty"`
	// Deprecated: Do not use.
	SourceDeprecated schema.Source     `protobuf:"varint,3,opt,name=source_deprecated,json=sourceDeprecated,proto3,enum=diginfra.schema.Source" json:"source_deprecated,omitempty"`
...
var file_outputs_proto_goTypes = []interface{}{
	(*Request)(nil),             // 0: diginfra.outputs.request
	(*Response)(nil),            // 1: diginfra.outputs.response
	nil,                         // 2: diginfra.outputs.response.OutputFieldsEntry
	(*timestamp.Timestamp)(nil), // 3: google.protobuf.Timestamp
	(schema.Priority)(0),        // 4: diginfra.schema.priority
	(schema.Source)(0),          // 5: diginfra.schema.source
}
var file_outputs_proto_depIdxs = []int32{
	3, // 0: diginfra.outputs.response.time:type_name -> google.protobuf.Timestamp
	4, // 1: diginfra.outputs.response.priority:type_name -> diginfra.schema.priority
	5, // 2: diginfra.outputs.response.source_deprecated:type_name -> diginfra.schema.source
	2, // 3: diginfra.outputs.response.output_fields:type_name -> diginfra.outputs.response.OutputFieldsEntry
	0, // 4: diginfra.outputs.service.sub:input_type -> diginfra.outputs.request
	0, // 5: diginfra.outputs.service.get:input_type -> diginfra.outputs.request
	1, // 6: diginfra.outputs.service.sub:output_type -> diginfra.outputs.response
	1, // 7: diginfra.outputs.service.get:output_type -> diginfra.outputs.response
