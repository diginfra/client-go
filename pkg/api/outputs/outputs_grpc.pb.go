...
const (
	Service_Sub_FullMethodName = "/diginfra.outputs.service/sub"
	Service_Get_FullMethodName = "/diginfra.outputs.service/get"
)
...
type ServiceClient interface {
	// Subscribe to a stream of Diginfra outputs by sending a stream of requests.
	Sub(ctx context.Context, opts ...grpc.CallOption) (Service_SubClient, error)
	// Get all the Diginfra outputs present in the system up to this call.
...
var Service_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "diginfra.outputs.service",
